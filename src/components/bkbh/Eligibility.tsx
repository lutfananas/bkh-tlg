      ...
      <div className="relative container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          {SKTM_STEPS.map((step, i) => (
            <motion.div
              ...
              className="relative rounded-2xl bg-card ring-1 ring-border hover:ring-primary/40 hover:shadow-xl hover:shadow-red-950/15 transition-all duration-500 p-6 md:p-8"
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="relative flex-shrink-0">
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-primary to-red-800 text-primary-foreground flex items-center justify-center font-heading text-xl md:text-2xl font-bold shadow-lg shadow-red-800/40">
                    {step.no}
                  </div>
                  <span className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-gold-accent text-charcoal flex items-center justify-center">
        ...
        <div className="mt-10 md:mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div
            ...
            className="rounded-2xl bg-gradient-to-br from-primary to-red-900 text-primary-foreground p-7 md:p-8 relative overflow-hidden"
          >
            <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full bg-gold-accent/15 blur-2xl" />
            <FileText className="w-10 h-10 text-gold-accent mb-4" />
            <h3 className="font-heading text-xl md:text-2xl font-bold mb-2">
              Formulir Pengajuan Intake
            </h3>
            <p className="text-sm md:text-base text-red-50/90 leading-relaxed mb-5">
              Unduh formulir intake resmi BKH Kartini. Cetak, isi, dan bawa
